...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Geolocation::IGeocoordinateSatelliteData2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_GeometricDilutionOfPrecision(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TimeDilutionOfPrecision(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Geolocation::IGeocoordinateWithRemoteSource>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsRemoteSource(bool*) noexcept = 0;
        };
    };
