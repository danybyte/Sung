...
Rectangle {
    ...
    property bool compactBar: false
    property string current: ""
    signal chosen(string key)

    implicitHeight: compactBar ? 64 : 80
    ...
    RowLayout {
        ...
        Repeater {
            ...
            delegate: AbstractButton {
                ...
                Layout.preferredHeight: bar.compactBar ? 56 : 64
                ...
                GridLayout {
                    ...
                    flow: bar.compactBar ? GridLayout.LeftToRight : GridLayout.TopToBottom
                    ...
                    Rectangle {
                        ...
                        implicitWidth: bar.compactBar ? 56 : 64; implicitHeight: 32
